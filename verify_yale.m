function [] = verify_yale(arg1,arg2)

srcFiles = dir('./dataset_yale/*.pgm');  % the folder in which ur images exists
k=50;

testimage=arg1;
%testlabel = str2num(arg(6:7))
testlabel = str2num(arg2);
...
display(trainlabel(minid))
if trainlabel(minid) == testlabel
    display('YES : Correctly Classified.')
else
    display('NO : Incorrectly Classified.')
end
